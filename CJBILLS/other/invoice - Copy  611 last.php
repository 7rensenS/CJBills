                ...
                <td colspan="2">
                  ...
                  <table id="invoice-item-table" class="table table-bordered table-hover table-striped">
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="pid" id="pid" onkeyup="GetDetail(this.value)" class="form-control input-sm" value=""/></td>
                      <td><input type="text" name="item_name[]" id="item_name1" class="form-control input-sm" value=""/></td>
                ...
                xmlhttp.onreadystatechange = function () {
                    ...
                    if (this.readyState == 4 && 
                        ...
                        document.getElementById
                            ("item_name1").value = myObj[0];
                          
                        // Assign the value received to
                        // last name input field
                        document.getElementById(
                            "order_item_price1").value = myObj[1];
                    }
                };
...
<!-- Add PRINT BUTTON -->
      ...
      $(document).ready(function(){
        ...
        $(document).on('click', '#add_row', function(){
          ...
          html_code += '<td><input type="text" name="pid" id="pid'+count+'"   onkeyup="GetDetail(this.value)" class="form-control input-sm" value=""/></td>';
          
          html_code += '<td><input type="text" name="item_name[]" id="item_name'+count+'" data-srno="'+count+'" class="form-control input-sm" /></td>';
