                ...
                <td colspan="2">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-group">
                      <input type="text" name="order_no" id="order_no" class="form-control input-sm number_only" maxlength="6" placeholder="Enter Invoice No." value=<?php echo rand(100,10000); ?> >
                      </div>
