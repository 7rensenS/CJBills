                ...
                <td colspan="2">
                  ...
                  <table id="invoice-item-table" class="table table-bordered table-hover table-striped">
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="pid" id=1 onkeyup="GetDetail(this.value,this.id)" class="form-control input-sm" value="" /></td>
...
<!-- Add PRINT BUTTON -->
      ...
      $(document).ready(function(){
        ...
        $(document).on('click', '#add_row', function(){
          ...
          html_code += '<td><input type="text" name="pid" id="'+count+'"   onkeyup="GetDetail(this.value,this.id)" class="form-control input-sm" value="" /></td>';
