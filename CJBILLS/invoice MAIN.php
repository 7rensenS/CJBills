  ...
  { 
    ...
    $statement->execute(
      ...
      for($count=0; $count<$_POST["total_item"]; $count++)
      {
        ...
        $statement = $connect->prepare("
          INSERT INTO bill_print (order_no, order_receiver_name, order_date, item_name, order_item_quantity, order_item_price, order_total_before_tax, order_total_after_tax)
          VALUES (:order_no, :order_receiver_name, :order_date, :item_name, :order_item_quantity, :order_item_price, :order_total_before_tax, :order_total_after_tax)
        ");
