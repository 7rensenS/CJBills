  ...
  { 
    ...
    $statement->execute(
      ...
      for($count=0; $count<$_POST["total_item"]; $count++)
      {
        ...
        $statement = $connect->prepare("
          INSERT INTO bill_print (order_no, order_receiver_name, order_date, item_name, order_item_quantity, order_item_price, order_item_actual_amount, order_total_before_tax, order_total_after_tax)
          VALUES (:order_no, :order_receiver_name, :order_date, :item_name, :order_item_quantity, :order_item_price, :order_item_actual_amount, :order_total_before_tax, :order_total_after_tax)
        ");
      ...
      header("location:printbill/print.php");
  }
        ...
        <div class="table-responsive">
          ...
          <div class="container-fluid">
            <div class="navbar-header" >
              <a class=" navbar-brand" href="invoice.php?add=1"> <b>CJ Billing System</b></a>
            </div>
          </div>
        </nav>
                ...
                <td colspan="2">
                  <div class="row">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="order_receiver_name" id="order_receiver_name" class="form-control input-sm" placeholder="Enter Receiver Name" value="Guest"/>
                        </div>
                        <!-- <div class="form-group">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-group">
                      <input type="text" name="order_no" id="order_no" class="form-control input-sm number_only" maxlength="6" placeholder="Enter Invoice No." value=<?php echo rand(100,100000); ?> >
                      </div>
                  ...
                  <table id="invoice-item-table" class="table table-bordered table-hover table-striped">
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="pid" autofocus id=1 onkeyup="GetDetail(this.value,this.id)" class="form-control input-sm" value="" /></td>
                      <td><input type="text" name="item_name[]" id="item_name11" class="form-control input-sm" value=""/></td>
            ...
            if (str.length == 0) {
                ...
                xmlhttp.onreadystatechange = function () {
                    ...
                    if (this.readyState == 4 && 
                        ...
                        document.getElementById("item_name1").value = myObj[0];
                          
                        // Assign the value received to
                        // last name input field
                        document.getElementById("order_item_price1").value = myObj[1];
                    }
                };
              ...
              <tr>
                <td colspan="2" align="center">
                  ...
                  <!-- <input type="submit" name="print" id="print" class="btn btn-success" value="Print" /> -->
...
<!-- Add PRINT BUTTON -->
              ...
              <tr>
                <td colspan="2" align="left">
                  <input type="submit" name="view_invoice" onClick="" id="view_invoice" class="btn btn-success" value="Show Old Bills" />
                  <?php
      ...
      $(document).ready(function(){
        ...
        $(document).on('click', '#add_row', function(){
          ...
          html_code += '<td><input type="text" autofocus name="pid" id="'+count+'"   onkeyup="GetDetail(this.value,this.id)" class="form-control input-sm" value="" /></td>';
          
          html_code += '<td><input type="text" name="item_name[]" id="item_name1'+count+'" data-srno="'+count+'" class="form-control input-sm" value="" /></td>';
...
<!-- <script>
  ...
  function GetDetail(str) {
      if (str.length == 0) {
          document.getElementById("item_name1" + count).value = "";
          document.getElementById("order_item_price1" + count).value = "";
          return;
      }
      else {
          ...
          xmlhttp.onreadystatechange = function () {
              ...
              if (this.readyState == 4 && 
                  ...
                  document.getElementById
                      ("item_name1" + count).value = myObj[0];
                    
                  // Assign the value received to
                  // last name input field
                  document.getElementById(
                      "order_item_price1" + count).value = myObj[1];
              }
          };
      ...
      if (str.length == 0) {
          ...
          xmlhttp.onreadystatechange = function () {
              ...
              if (this.readyState == 4 && 
                  ...
                  // document.getElementById('item_name1' + id).value = myObj[0];
                  var n = id; 
                  let str1 = "item_name1";
                  let str2 = str1.concat(n);

                  // document.getElementById("pp").value = str2;
                  document.getElementById(str2).value = myObj[0];

                  // account_number.toString()

                  // document.getElementById('account_' + account_number).value.
                    
                  // document.getElementById('order_item_price1' + id).value = myObj[1];

                  let str3 = "order_item_price";
                  let str4 = str3.concat(n);

                  // document.getElementById("pp").value = str4;
                 
                  document.getElementById(str4).value = myObj[1];
              }
          };
...
<!-- EDIT FORM XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX -->



        <form method="post" id="invoice_form" action="print.php">
            <nav class="navbar navbar-default card">
          <div class="container-fluid">
            <div class="navbar-header" >
...
<!-- INVOICE BILLING SYSTEM PDF PAGE -->
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">CJ Billing System</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <form class="navbar-form navbar-right">
